...
class PuLIDPipeline:
    def __init__(self, *args, **kwargs):
        ...
        self.app = FaceAnalysis(
            ...
            name='antelopev2', root='.', providers=['CUDAExecutionProvider']
        )
        ...
        self.handler_ante = insightface.model_zoo.get_model('models/antelopev2/glintr100.onnx', providers=['CUDAExecutionProvider'])
    ...
    def inference(self, prompt, size, prompt_n='', image_embedding=None, id_scale=1.0, guidance_scale=7.0, steps=40):
        images = self.pipe(
            prompt=prompt,
